...
export function TopBar(props: TopBarProps) {
  const {
    topBarRef, sidebarOpen, onToggleSidebar, isDark, onToggleTheme,
    canOpenTerminal, onOpenTerminal, showGit, gitActive, onOpenGit,
    showChatTools, branchTree, branchActiveLeafId, onBranchLeafChange,
    activeTopPanel, onTogglePanel, systemBtnRef, systemPrompt, topPanelPos,
    sessionStats, contextUsage, rightPanelInset,
  } = props;
  ...
  return (
    <div ref={topBarRef} style={{ display: "flex", alignItems: "center", flexShrink: 0, borderBottom: "1px solid var(--border)", height: 36, background: "var(--bg-panel)" }}>
      ...
      <button
        ...
        title={canOpenTerminal ? "Open in system terminal" : "Please select a project first"}
        aria-label="Open terminal"
        style={{
          display: "flex", alignItems: "center", justifyContent: "center",
          width: 36, height: 36, padding: 0,
          background: "none", border: "none", borderRight: "1px solid var(--border)",
          color: "var(--text-muted)", cursor: canOpenTerminal ? "pointer" : "not-allowed",
          flexShrink: 0, transition: "color 0.12s",
          opacity: canOpenTerminal ? 1 : 0.45,
        }}
        onMouseEnter={(e) => { if (canOpenTerminal) e.currentTarget.style.color = "var(--text)"; }}
        onMouseLeave={(e) => { e.currentTarget.style.color = "var(--text-muted)"; }}
      >
      ...
      {showGit && (
        <button
          ...
          onMouseEnter={(e) => { e.currentTarget.style.color = "var(--text)"; }}
          onMouseLeave={(e) => { e.currentTarget.style.color = gitActive ? "var(--text)" : "var(--text-muted)"; }}
        >
          <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      {showChatTools && (sessionStats || contextUsage) && (() => {
